...
#genrate weather report 1 as in Assignment_Description
def report1():
...
#genrate weather report 2 as in Assignment_Description    
def report2():
     parser = argparse.ArgumentParser(description='weather report')
...
#genrate weather report 3 as in Assignment_Description        
def report3():
     parser = argparse.ArgumentParser(description='weather report')
     parser.add_argument("year",type=str)
     parser.add_argument("month", help="month name Example:Jan",type=str)
